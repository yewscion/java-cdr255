...
# The `java-cdr255` README

**A User Library for Java.**

*Last Updated: 2022-08-02 (W31) 18:28:48 GMT*
...
You can clone this repo and install it in the normal way:
    ...
    git clone https://git.sr.ht/~yewscion/java-cdr255
    cd java-cdr255
    ./configure
    make
    make check
...
Full usage is documented in the `doc/java-cdr255.info` file. Here are
only generic instructions.

Once `java-cdr255` in installed, You should be able to access all of
...
The `java-cdr255` project and all associated files are ©2022 Christopher
