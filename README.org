#+title: The =java-cdr255= README
# variables: java-cdr255, A User Library for Java
#+subtitle: A User Library for Java
#+date: <2022-06-13 Mon 17:54>
#+description: A User Library for Java
...
#+macro: summary A User Library for Java.
#+macro: guixinfo (eval (cdr:readme-guix-instructions "java-cdr255"))
#+macro: srcinfo (eval (cdr:readme-src-instructions "java-cdr255"))
#+macro: installinfo (eval (cdr:readme-install-instructions "java-cdr255"))
#+macro: useinfo (eval (cdr:readme-std-usage-instructions "java-cdr255"))
#+macro: contribinfo (eval (cdr:readme-contrib-instructions "java-cdr255"))
#+macro: licenseinfo (eval (cdr:readme-license-instructions "java-cdr255" "agpl"))
** {{{TITLE}}}
